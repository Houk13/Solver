...
let colorCell = (div: HTMLDivElement) =>{
...
let buildHTMLGrid = () => {
    let nCols = document.querySelector('#nOfColumns') as HTMLInputElement;
    let nRows = document.getElementById('nOfRows') as HTMLInputElement;
